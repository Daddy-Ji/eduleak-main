...
const portalDefault = { title: "", subtitle: "", description: "", emoji: "📚", logo_url: "", link_url: "", whatsapp_url: "", category: "", embed_in_app: false, display_order: 0, is_active: true };
